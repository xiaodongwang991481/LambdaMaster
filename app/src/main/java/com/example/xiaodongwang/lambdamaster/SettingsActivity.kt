...
class SettingsActivity : AppCompatPreferenceActivity() {
    ...
    class GeneralPreferenceFragment : PreferenceFragment() {
        override fun onCreate(savedInstanceState: Bundle?) {
            ...
            // guidelines.
            bindPreferenceSummaryToValue(findPreference("rabbitmq_host"))
            bindPreferenceSummaryToValue(findPreference("rabbitmq_virtualhost"))
            bindPreferenceSummaryToValue(findPreference("rabbitmq_username"))
            bindPreferenceSummaryToValue(findPreference("rabbitmq_password"))
